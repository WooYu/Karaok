...
//        if (TextUtils.isEmpty(config.getUrl())) throw new NullPointerException("Url is required");
        ...
        if (TextUtils.isEmpty(config.getUrl()) && config.getFileImage() == null) {
            DrawableRequestBuilder<String> requestBuilder = manager.load("")
                    .crossFade()
                    .centerCrop();
            ...
            DrawableRequestBuilder<File> requestBuilder = manager.load(config.getFileImage())
                    .crossFade()
                    .centerCrop();
