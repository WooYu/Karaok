package com.clicktech.snsktv.arms.widget.pulltozoomview;
...
public class PullToZoomRecyclerViewEx extends PullToZoomBase<RecyclerView> {
    ...
    private PullToZoomListener mZoomListener;
                    ...
                    if (isParallax()) {
                        if ((f > 0.0F) && (f < mHeaderHeight)) {
                            ...
                            if (null != mZoomListener)
                                mZoomListener.onScrollChange(f / mHeaderHeight);
    ...
    public void setPullToZoomListener(PullToZoomListener listener) {
