...
@ActivityScope
public class CantataModel extends BaseModel<ServiceManager, CacheManager> implements CantataContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public CantataModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
