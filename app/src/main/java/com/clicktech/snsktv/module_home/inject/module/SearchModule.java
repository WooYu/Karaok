...
import com.clicktech.snsktv.module_home.model.SearchModel;
...
public class SearchModule {
    ...
    @ActivityScope
    @Provides
    SearchContract.Model provideSearchModel(ServiceManager serviceManager, CacheManager cacheManager
            , Gson gson, Application application) {
        return new SearchModel(serviceManager, cacheManager, gson, application);
    }
}