...
@ActivityScope
@Component(modules = KSingWithMVModule.class, dependencies = AppComponent.class)
public interface KSingWithMVComponent {
    void inject(KSingWithMVActivity activity);
}