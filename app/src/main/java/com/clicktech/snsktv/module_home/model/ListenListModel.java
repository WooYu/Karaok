...
@ActivityScope
public class ListenListModel extends BaseModel<ServiceManager, CacheManager> implements ListenListContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public ListenListModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
