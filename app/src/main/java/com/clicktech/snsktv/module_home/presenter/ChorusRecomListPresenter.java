...
@ActivityScope
public class ChorusRecomListPresenter extends BasePresenter<ChorusRecomListContract.Model, ChorusRecomListContract.View> {
    private RxErrorHandler mErrorHandler;
    private Application mApplication;
    private ImageLoader mImageLoader;
    private AppManager mAppManager;

    private List<SongInfoBean> mChorusList = new ArrayList<>();
    private ChorusRecomListAdapter mChorusAdapter;

    @Inject
    public ChorusRecomListPresenter(ChorusRecomListContract.Model model, ChorusRecomListContract.View rootView
        ...
        mChorusAdapter = new ChorusRecomListAdapter(mChorusList);
        mChorusAdapter.setOnItemClickListener(new DefaultAdapter.OnRecyclerViewItemClickListener<SongInfoBean>() {
            @Override
        ...
        mRootView.setChorusRecomRecyclerView(mChorusAdapter);
    }
    ...
    public void requestData() {
        mChorusAdapter.notifyDataSetChanged();
    }
                ...
                .subscribe(new ErrorHandleSubscriber<ListOfWorksResponse>(mErrorHandler) {
                    ...
                    public void onNext(ListOfWorksResponse singInfo) {
                        ...
                        if (singInfo.getSongWorksList() != null) {
                            mChorusList.addAll(singInfo.getSongWorksList());
                        }
