...
@ActivityScope
@Component(modules = YearsBetweenSetModule.class, dependencies = AppComponent.class)
public interface YearsBetweenSetComponent {
    void inject(YearsBetweenSetActivity activity);
}