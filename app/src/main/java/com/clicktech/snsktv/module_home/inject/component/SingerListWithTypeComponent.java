...
@ActivityScope
@Component(modules = SingerListWithTypeModule.class, dependencies = AppComponent.class)
public interface SingerListWithTypeComponent {
    void inject(SingerListWithTypeActivity activity);
}