...
import com.clicktech.snsktv.module_home.model.ListenListModel;
...
public class ListenListModule {
    ...
    /**
     * 构建ListenListModule时,将View的实现类传进来,这样就可以提供View的实现类给presenter
     *
     * @param view
     */
    ...
    @ActivityScope
    @Provides
    ListenListContract.View provideListenListView() {
        return this.view;
    }

    @ActivityScope
    @Provides
    ListenListContract.Model provideListenListModel(ListenListModel model) {
        return model;
    }
}