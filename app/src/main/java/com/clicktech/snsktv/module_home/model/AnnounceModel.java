...
@ActivityScope
public class AnnounceModel extends BaseModel<ServiceManager, CacheManager> implements AnnounceContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public AnnounceModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
    ...
    @Override
    public Observable<BaseResponse> publishWorksScore(ScoreResultEntity entity) {
        return mServiceManager.getCommonService().publishWorksScore(RequestParams_Maker.getPublishWorksScore(entity));
    }
