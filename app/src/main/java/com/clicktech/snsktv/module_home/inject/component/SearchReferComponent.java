...
@ActivityScope
@Component(modules = SearchReferModule.class, dependencies = AppComponent.class)
public interface SearchReferComponent {
    void inject(SearchReferFragment fragment);
}