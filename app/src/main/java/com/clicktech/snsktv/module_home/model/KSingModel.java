...
@ActivityScope
public class KSingModel extends BaseModel<ServiceManager, CacheManager> implements KSingContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public KSingModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
    ...
    @Override
    public Observable<ResponseBody> downFileWithDynamicUrlSync(String url) {
        return mServiceManager.getCommonService()
