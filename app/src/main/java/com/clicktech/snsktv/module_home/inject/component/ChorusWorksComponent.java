...
@ActivityScope
@Component(modules = ChorusWorksModule.class, dependencies = AppComponent.class)
public interface ChorusWorksComponent {
    void inject(ChorusWorksActivity activity);
}