...
public interface SearchReferContract {
    //对于经常使用的关于UI的方法可以定义到BaseView中,如显示隐藏进度条,和显示文字消息
    interface View extends BaseView {
        //设置常用歌手的RecyclerView
        void setHotSingerView(CommonSingerAdapter adapter);

        //设置历史记录的RecyclerView
        void setHistoryView(SearchHistoryAdapter adapter);

        //是否显示搜索历史
        void showHistoryRecord(boolean showRecord);
    }
