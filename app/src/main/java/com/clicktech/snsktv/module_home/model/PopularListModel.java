...
@ActivityScope
public class PopularListModel extends BaseModel<ServiceManager, CacheManager> implements PopularListContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public PopularListModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
