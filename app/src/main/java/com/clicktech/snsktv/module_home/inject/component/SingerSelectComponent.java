...
@ActivityScope
@Component(modules = SingerSelectModule.class, dependencies = AppComponent.class)
public interface SingerSelectComponent {
    void inject(SingerSelectActivity activity);
}