...
@ActivityScope
public class LearnSingModel extends BaseModel<ServiceManager, CacheManager> implements LearnSingContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public LearnSingModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
    ...
    @Override
    public Observable<SongInfoWithSongIDResponse> getSingInfo(Map<String, String> info) {
        return mServiceManager.getCommonService()
                .getSongInfoWithSongID(info);
    }
}
