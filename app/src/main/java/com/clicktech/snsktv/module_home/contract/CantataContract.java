...
public interface CantataContract {
    ...
    interface View extends BaseView {
        ...
        //更新录制时间
        void updateRecodingTime(int time);

        //更新录制状态
        void updateReordingStatus(boolean status);

        //跳转到发布界面
        void turn2Publish(String recordPath, String accompanyPath);
    }
