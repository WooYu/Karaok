...
@ActivityScope
public class MusicHallPresenter extends BasePresenter<MusicHallContract.Model, MusicHallContract.View> {
    ...
    @Inject
    public MusicHallPresenter(MusicHallContract.Model model, MusicHallContract.View rootView
    ...
    //获取轮播图
    public void requestBannerData(String userid) {
        mModel.getBanners(userid, mApplication.getResources().getInteger(R.integer.wheeltype_home))
