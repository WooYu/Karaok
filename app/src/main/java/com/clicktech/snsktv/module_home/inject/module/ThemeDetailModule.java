...
import com.clicktech.snsktv.module_home.model.ThemeDetailModel;
...
public class ThemeDetailModule {
    ...
    /**
     * 构建ThemeDetailModule时,将View的实现类传进来,这样就可以提供View的实现类给presenter
     *
     * @param view
     */
    ...
    @ActivityScope
    @Provides
    ThemeDetailContract.View provideThemeDetailView() {
        return this.view;
    }

    @ActivityScope
    @Provides
    ThemeDetailContract.Model provideThemeDetailModel(ThemeDetailModel model) {
        return model;
    }
}