...
@ActivityScope
public class ToBeAnnoWithMVModel extends BaseModel<ServiceManager, CacheManager> implements ToBeAnnoWithMVContract.Model {
    ...
    private static final int[] inflexionImgs = new int[]{
            R.drawable.selector_bg_reverb0, R.drawable.selector_bg_reverb1,
            R.drawable.selector_bg_reverb2, R.drawable.selector_bg_reverb3,
            R.drawable.selector_bg_reverb4
    };
    private Gson mGson;
    private Application mApplication;

    @Inject
    public ToBeAnnoWithMVModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
