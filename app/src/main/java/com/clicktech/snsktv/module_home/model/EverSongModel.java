...
@ActivityScope
public class EverSongModel extends BaseModel<ServiceManager, CacheManager> implements EverSongContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public EverSongModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
