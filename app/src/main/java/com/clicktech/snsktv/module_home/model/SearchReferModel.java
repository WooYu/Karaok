...
public class SearchReferModel extends BaseModel<ServiceManager, CacheManager> implements SearchReferContract.Model {
    private Gson mGson;
    private Application mApplication;

    public SearchReferModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
