...
@ActivityScope
@Component(modules = ChorusSingerModule.class, dependencies = AppComponent.class)
public interface ChorusSingerComponent {
    void inject(ChorusSingerActivity activity);
}