...
@ActivityScope
public class PracticingSongModel extends BaseModel<ServiceManager, CacheManager> implements PracticingSongContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public PracticingSongModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
