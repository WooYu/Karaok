...
@ActivityScope
public class CategoryModel extends BaseModel<ServiceManager, CacheManager> implements CategoryContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public CategoryModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
