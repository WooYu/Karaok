...
@ActivityScope
public class SingerListWithTypeModel extends BaseModel<ServiceManager, CacheManager> implements SingerListWithTypeContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public SingerListWithTypeModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
    ...
    @Override
    public Observable<SingerListWithCatecoryResponse> getSingerList(Map<String, String> info) {

        return mServiceManager.getCommonService()
                .getSingerList_WithType(info);
    }
}