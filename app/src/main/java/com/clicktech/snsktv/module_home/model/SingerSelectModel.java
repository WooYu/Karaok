...
public class SingerSelectModel extends BaseModel<ServiceManager, CacheManager> implements
        SingerSelectContract.Model {
    private Gson mGson;
    private Application mApplication;

    public SingerSelectModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
...
//        List<SingInfoResponse> list  = new ArrayList<>();
//        for (int i = 0; i < 6; i++) {
//            list.add(new SingInfoResponse());
//        }
