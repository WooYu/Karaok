...
public class PopularListHolder extends BaseHolder<SongInfoBean> {
    ...
    public PopularListHolder(View itemView, PopularListHolder.onItemClickListener listener) {
        super(itemView);
    ...
    public void setData(SongInfoBean data, int position) {
        ...
        itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (null != mListener) {
                    mListener.itemClick(getLayoutPosition() - 1);
                }
            }
        });
