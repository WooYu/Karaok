...
@ActivityScope
public class YearsBetweenSetModel extends BaseModel<ServiceManager, CacheManager> implements YearsBetweenSetContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public YearsBetweenSetModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
