...
@ActivityScope
public class SongSortPresenter extends BasePresenter<SongSortContract.Model, SongSortContract.View> {
    ...
    @Inject
    public SongSortPresenter(SongSortContract.Model model, SongSortContract.View rootView
        ...
        mAdapter = new SongsortAdapter(mList);
    ...
    public void requestData_WithCategory(String categoryid) {
        ...
        mModel.getSongListWithCategory(RequestParams_Maker.getSongList_WithCategroy(
                categoryid, mCurPage, mPageSize))
