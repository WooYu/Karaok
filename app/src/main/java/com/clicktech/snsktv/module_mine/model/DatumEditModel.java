...
@ActivityScope
public class DatumEditModel extends BaseModel<ServiceManager, CacheManager> implements
        DatumEditContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public DatumEditModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
    ...
    @Override
    public Observable<BaseResponse> modifyUserInfo(Map<String, RequestBody> info, MultipartBody.Part part) {
        return mServiceManager.getCommonService()
                .modifyUserInfo(info, part);
    }
