...
public interface Mine_AttentionContract {
    //对于经常使用的关于UI的方法可以定义到BaseView中,如显示隐藏进度条,和显示文字消息
    interface View extends BaseView {
        void requestCompletion();

        void updateData(List<MineAttentEntity> list);
    ...
    interface Model extends IModel {
        //获取关注列表
        Observable<Att_ListResponse> getMine_AttentionList(Map<String, String> info);
