...
import com.clicktech.snsktv.module_mine.model.SystemMsgModel;
...
public class SystemMsgModule {
    ...
    /**
     * 构建SystemMsgModule时,将View的实现类传进来,这样就可以提供View的实现类给presenter
     *
     * @param view
     */
    ...
    @ActivityScope
    @Provides
    SystemMsgContract.View provideSystemMsgView() {
        return this.view;
    }

    @ActivityScope
    @Provides
    SystemMsgContract.Model provideSystemMsgModel(SystemMsgModel model) {
        return model;
    }
}