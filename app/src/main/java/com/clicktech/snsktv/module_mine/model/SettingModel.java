...
@ActivityScope
public class SettingModel extends BaseModel<ServiceManager, CacheManager> implements
    ...
    @Override
    public Observable<VersionMessageResponse> getVsersionMessage(Map<String, String> info) {
        Observable<VersionMessageResponse> message = mServiceManager.getCommonService()
                .checkNewVersion(info);
        return message;
    }

    @Override
    public Observable<BaseResponse> signOut(Map<String, String> info) {
        Observable<BaseResponse> responseObservable = mServiceManager.getCommonService()
                .signOut(info);
