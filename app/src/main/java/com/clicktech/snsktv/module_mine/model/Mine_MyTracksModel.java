...
@ActivityScope
public class Mine_MyTracksModel extends BaseModel<ServiceManager, CacheManager> implements Mine_MyTracksContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public Mine_MyTracksModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
