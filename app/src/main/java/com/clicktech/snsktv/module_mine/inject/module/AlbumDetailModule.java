...
import com.clicktech.snsktv.module_mine.model.AlbumDetailModel;
...
public class AlbumDetailModule {
    ...
    /**
     * 构建AlbumDetailModule时,将View的实现类传进来,这样就可以提供View的实现类给presenter
     *
     * @param view
     */
    ...
    @ActivityScope
    @Provides
    AlbumDetailContract.View provideAlbumDetailView() {
        return this.view;
    }

    @ActivityScope
    @Provides
    AlbumDetailContract.Model provideAlbumDetailModel(AlbumDetailModel model) {
        return model;
    }
}