...
public interface LocalRecordingContract {
    //对于经常使用的关于UI的方法可以定义到BaseView中,如显示隐藏进度条,和显示文字消息
    interface View extends BaseView {
        void setSwipRecyclerView(SwipLocalRecordingAdapter swipAdapter,
    ...
    interface Model extends IModel {
        Observable<WorksListResponse> getSingerList(Map<String, String> info);

        Observable<BaseResponse> deleteAccompany(Map<String, String> info);
    }
}