...
import com.clicktech.snsktv.module_mine.model.MessageModel;
...
public class MessageModule {
    ...
    @ActivityScope
    @Provides
    MessageContract.Model provideMessageModel(ServiceManager serviceManager, CacheManager cacheManager
            , Gson gson, Application application) {
        return new MessageModel(serviceManager, cacheManager, gson, application);
    }
}