...
public interface LatelyListenerContract {
    //对于经常使用的关于UI的方法可以定义到BaseView中,如显示隐藏进度条,和显示文字消息
    interface View extends BaseView {

        void setRecyclerView(LatelyListenerAdapter adapter);

        void updateListenTimes(String todaycount, String totalcount);
    }
    ...
    interface Model extends IModel {
        ...
        //最近听众
        Observable<LatelyListenerResponse> latelyListener(Map<String, String> info);
