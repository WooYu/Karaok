...
@ActivityScope
public class SingleMusicForAlbumModel extends BaseModel<ServiceManager, CacheManager> implements
        SingleMusicForAlbumContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public SingleMusicForAlbumModel(ServiceManager serviceManager, CacheManager cacheManager,
    ...
    @Override
    public Observable<WorksForAlbumResponse> getWorksForAlbum(Map<String, String> info) {
        return mServiceManager.getCommonService().getSelectWorksForAlbum(info);
    }
}