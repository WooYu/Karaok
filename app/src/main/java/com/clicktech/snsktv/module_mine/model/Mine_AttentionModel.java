...
@ActivityScope
public class Mine_AttentionModel extends BaseModel<ServiceManager, CacheManager> implements Mine_AttentionContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public Mine_AttentionModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
    ...
    @Override
    public Observable<Att_ListResponse> getMine_AttentionList(Map<String, String> info) {
        return mServiceManager.getCommonService()
                .getMine_AttentionList(info);
    }
