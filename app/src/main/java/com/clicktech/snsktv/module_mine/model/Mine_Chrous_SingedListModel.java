...
@ActivityScope
public class Mine_Chrous_SingedListModel extends BaseModel<ServiceManager, CacheManager> implements Mine_Chrous_SingedListContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public Mine_Chrous_SingedListModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
    ...
    @Override
    public Observable<ChrousSonged_ListResponse> getSongedList(Map<String, String> info) {

        return mServiceManager.getCommonService()
                .getMine_ChrousSongedList(info);
    }
}