...
@ActivityScope
public class FunctionintroModel extends BaseModel<ServiceManager, CacheManager> implements FunctionintroContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public FunctionintroModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
