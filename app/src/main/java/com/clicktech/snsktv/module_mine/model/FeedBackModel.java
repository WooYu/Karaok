...
@ActivityScope
public class FeedBackModel extends BaseModel<ServiceManager, CacheManager> implements
        FeedBackContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public FeedBackModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
