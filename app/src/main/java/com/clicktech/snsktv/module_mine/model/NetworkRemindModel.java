...
@ActivityScope
public class NetworkRemindModel extends BaseModel<ServiceManager, CacheManager> implements
        NetworkRemindContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public NetworkRemindModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
