...
@ActivityScope
public class AboutOurModel extends BaseModel<ServiceManager, CacheManager> implements AboutOurContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public AboutOurModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
