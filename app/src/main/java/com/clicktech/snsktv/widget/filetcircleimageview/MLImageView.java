package com.clicktech.snsktv.widget.filetcircleimageview;
...
public class MLImageView extends android.support.v7.widget.AppCompatImageView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            borderColor = array.getColor(R.styleable.MLImageView_mlborder_color, borderColor);
            borderWidth = array.getDimensionPixelOffset(R.styleable.MLImageView_mlborder_width, borderWidth);
            pressAlpha = array.getInteger(R.styleable.MLImageView_press_alpha, pressAlpha);
            pressColor = array.getColor(R.styleable.MLImageView_press_color, pressColor);
            radius = array.getDimensionPixelOffset(R.styleable.MLImageView_radius, radius);
            shapeType = array.getInteger(R.styleable.MLImageView_shape_type, shapeType);
            array.recycle();
        }
