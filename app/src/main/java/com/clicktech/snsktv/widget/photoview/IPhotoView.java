 ...
 * limitations under the License.
 *******************************************************************************/
package com.clicktech.snsktv.widget.photoview;
...
public interface IPhotoView {
    ...
    /**
     * Whether to allow the ImageView's parent to intercept the touch event when the photo is cc_scroll to it's horizontal edge.
     */
