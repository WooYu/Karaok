...
public class MVPreviewPlayer extends JZVideoPlayerStandard {

    private boolean bPause = false;

    public MVPreviewPlayer(Context context) {
        super(context);
    }

    public MVPreviewPlayer(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public void setUpParams(String videoUrl, String thumbUrl) {
        ...
        KtvApplication.ktvApplication.getAppComponent().imageLoader().loadImage(getContext(),
                GlideImageConfig.builder()
                        .url(StringHelper.getImageUrl(thumbUrl))
