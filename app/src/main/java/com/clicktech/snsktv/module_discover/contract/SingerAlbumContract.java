...
public interface SingerAlbumContract {
    //对于经常使用的关于UI的方法可以定义到BaseView中,如显示隐藏进度条,和显示文字消息
    interface View extends BaseView {

        //设置adapter
        void setRecyclerAdapter(PhotoAlbumAdapter adapter);
    ...
    interface Model extends IModel {
        //获取相册
        Observable<SingerAlbumResponse> getSingerAlbum(String userid, int curpage, int pagesize);

        //删除相册
        Observable<BaseResponse> getDeleteAlbum(Map<String, String> info);
    }
}