...
import com.clicktech.snsktv.module_discover.model.AlbumModel;
...
public class AlbumModule {
    ...
    /**
     * 构建AlbumModule时,将View的实现类传进来,这样就可以提供View的实现类给presenter
     *
     * @param view
     */
    ...
    @ActivityScope
    @Provides
    AlbumContract.View provideAlbumView() {
        return this.view;
    }

    @ActivityScope
    @Provides
    AlbumContract.Model provideAlbumModel(AlbumModel model) {
        return model;
    }
}