...
@ActivityScope
public class MvPreviewFirstModel extends BaseModel<ServiceManager, CacheManager> implements MvPreviewFirstContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public MvPreviewFirstModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
