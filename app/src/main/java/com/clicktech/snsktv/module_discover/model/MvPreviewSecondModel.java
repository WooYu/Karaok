...
@ActivityScope
public class MvPreviewSecondModel extends BaseModel<ServiceManager, CacheManager> implements
        MvPreviewSecondContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public MvPreviewSecondModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson,
