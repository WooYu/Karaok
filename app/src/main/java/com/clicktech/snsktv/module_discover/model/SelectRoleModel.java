...
@ActivityScope
public class SelectRoleModel extends BaseModel<ServiceManager, CacheManager> implements
        SelectRoleContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public SelectRoleModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
