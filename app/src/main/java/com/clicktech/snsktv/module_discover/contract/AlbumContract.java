...
public interface AlbumContract {
    ...
    interface View extends BaseView {
        //设置专辑的RecyclerView
        void setAlbumListRecyclerView(AlbumListAdapter adapter);

        //设置单曲的RecyclerView
        void setSingleRecyclerView(SingleListAdapter adapter);

        //展示空的专辑提示
        void showEmptyAlbum(Boolean isShow);

        //展示空的单曲提示
        void showEmptyMusic(Boolean isShow);
