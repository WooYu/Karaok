...
@ActivityScope
@Component(modules = MvPreviewFirstModule.class, dependencies = AppComponent.class)
public interface MvPreviewFirstComponent {
    void inject(MvPreviewFirstActivity activity);
}