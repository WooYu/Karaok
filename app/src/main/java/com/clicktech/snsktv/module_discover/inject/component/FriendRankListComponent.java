...
@ActivityScope
@Component(modules = FriendRankListModule.class, dependencies = AppComponent.class)
public interface FriendRankListComponent {
    void inject(FriendRankListActivity activity);
}