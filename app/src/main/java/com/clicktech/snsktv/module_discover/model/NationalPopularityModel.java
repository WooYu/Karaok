...
@ActivityScope
public class NationalPopularityModel extends BaseModel<ServiceManager, CacheManager> implements
        NationalPopularityContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public NationalPopularityModel(ServiceManager serviceManager, CacheManager cacheManager,
    ...
    @Override
    public Observable<RankingResponse> getPopularList(Map<String, String> info) {
        return mServiceManager.getCommonService()
                .getDiacoverNationalPopularList(info);
    }
