...
public interface NationalPopularityContract {
    //对于经常使用的关于UI的方法可以定义到BaseView中,如显示隐藏进度条,和显示文字消息
    interface View extends BaseView {
        //设置全国人气榜的RecyclerView
        void setNationPopRecyclerView(NationPopularAdapter adapter);
    ...
    interface Model extends IModel {
        Observable<RankingResponse> getPopularList(Map<String, String> info);
