...
@ActivityScope
public class PlayRightModel extends BaseModel<ServiceManager, CacheManager> implements PlayRightContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public PlayRightModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
