...
@ActivityScope
@Component(modules = DiverseListModule.class, dependencies = AppComponent.class)
public interface DiverseListComponent {
    void inject(DiverseListFragment fragment);
}