...
@ActivityScope
public class ChooseProinceModel extends BaseModel<ServiceManager, CacheManager> implements ChooseProinceContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public ChooseProinceModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
