...
@ActivityScope
@Component(modules = NationalPopularityModule.class, dependencies = AppComponent.class)
public interface NationalPopularityComponent {
    void inject(NationalPopularityActivity activity);
}