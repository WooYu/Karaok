...
@ActivityScope
public class PlayMiddleModel extends BaseModel<ServiceManager, CacheManager> implements
        PlayMiddleContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public PlayMiddleModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson,
