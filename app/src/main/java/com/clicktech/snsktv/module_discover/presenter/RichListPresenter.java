...
@ActivityScope
public class RichListPresenter extends BasePresenter<RichListContract.Model, RichListContract.View> {
    ...
    @Inject
    public RichListPresenter(RichListContract.Model model, RichListContract.View rootView
    ...
    public void requestData_BackGround() {
        ...
        int type = mApplication.getResources().getInteger(R.integer.wheeltype_rich);
