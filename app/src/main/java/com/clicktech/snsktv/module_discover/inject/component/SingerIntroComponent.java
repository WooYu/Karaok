...
@ActivityScope
@Component(modules = SingerIntroModule.class, dependencies = AppComponent.class)
public interface SingerIntroComponent {
    void inject(SingerIntroActivity activity);
}