...
@ActivityScope
public class ListenRankPresenter extends BasePresenter<ListenRankContract.Model, ListenRankContract.View> {
    private RxErrorHandler mErrorHandler;
    private Application mApplication;
    private ImageLoader mImageLoader;
    private AppManager mAppManager;

    private List<SongInfoBean> songs = new ArrayList<>();
    private RankListenAdapter listenRankSongsActivityAdapter;

    @Inject
    public ListenRankPresenter(ListenRankContract.Model model, ListenRankContract.View rootView
        ...
        listenRankSongsActivityAdapter = new RankListenAdapter(songs);
        mRootView.setListenRankSongs(listenRankSongsActivityAdapter);
    }
    ...
    public void onDestroy() {
        ...
        this.songs = null;
        this.listenRankSongsActivityAdapter = null;
    }
    ...
    public void requestData() {
        ...
        mModel.getDiscoverListenRankSongsList(RequestParams_Maker.getListenRankSongs(mCurPage, mPageSize))
                .compose(RxUtils.<DiscoverListenRankSongsResponse>applySchedulers(mRootView))
                .subscribe(new ErrorHandleSubscriber<DiscoverListenRankSongsResponse>(mErrorHandler) {
                    @Override
                    public void onNext(DiscoverListenRankSongsResponse singInfo) {
                        songs = singInfo.getAuditionCharts();
                        listenRankSongsActivityAdapter.setmInfos(songs);
                    }
    ...
    public void requestData_BackGround() {
        ...
        int type = mApplication.getResources().getInteger(R.integer.wheeltype_audition);
