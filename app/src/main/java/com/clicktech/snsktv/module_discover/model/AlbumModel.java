...
@ActivityScope
public class AlbumModel extends BaseModel<ServiceManager, CacheManager> implements AlbumContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public AlbumModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
