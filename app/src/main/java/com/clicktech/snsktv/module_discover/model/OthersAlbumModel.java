...
@ActivityScope
public class OthersAlbumModel extends BaseModel<ServiceManager, CacheManager> implements OthersAlbumContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public OthersAlbumModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
    ...
    public Observable<SingerAlbumResponse> getSingerAlbum(Map<String, String> info) {
        Observable<SingerAlbumResponse> singerAlbumList = mServiceManager.getCommonService()
