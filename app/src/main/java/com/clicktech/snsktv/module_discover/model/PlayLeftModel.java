...
@ActivityScope
public class PlayLeftModel extends BaseModel<ServiceManager, CacheManager> implements
        PlayLeftContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public PlayLeftModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
