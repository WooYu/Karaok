...
@ActivityScope
public class GIftRankModel extends BaseModel<ServiceManager, CacheManager> implements GIftRankContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public GIftRankModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
    ...
    public Observable<AlbumDetailResponse> getAlbumDetail(Map<String, String> info) {
        return mServiceManager.getCommonService().getAlbumDetail(info);
    }

    @Override
    public Observable<GIftRankResponse> getGiftRank(Map<String, String> info) {
        return mServiceManager.getCommonService().giftRank(info);
    }
