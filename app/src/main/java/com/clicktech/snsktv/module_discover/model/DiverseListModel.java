...
@ActivityScope
public class DiverseListModel extends BaseModel<ServiceManager, CacheManager> implements
        DiverseListContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public DiverseListModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
    ...
    @Override
    public Observable<RichListResponse> getDiscoverHotSingersList(Map<String, String> info) {
        return mServiceManager.getCommonService()
                .getDiacoverRichList(info);
    }
}
