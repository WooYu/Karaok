...
import com.clicktech.snsktv.module_discover.model.DiscoverModel;
...
public class DiscoverModule {
    ...
    @ActivityScope
    @Provides
    DiscoverContract.Model provideDiscoverModel(ServiceManager serviceManager, CacheManager cacheManager
            , Gson gson, Application application) {
        return new DiscoverModel(serviceManager, cacheManager, gson, application);
    }
}