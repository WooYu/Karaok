...
@ActivityScope
@Component(modules = SingerAlbumModule.class, dependencies = AppComponent.class)
public interface SingerAlbumComponent {
    void inject(SingerAlbumActivity activity);
}