...
package com.clicktech.snsktv.util.amazonaws;
...
public class Util {
    ...
    private static CognitoCachingCredentialsProvider getCredProvider(Context context) {
        if (sCredProvider == null) {
            sCredProvider = new CognitoCachingCredentialsProvider(
                    ...
                    Regions.fromName(BuildConfig.COGNITO_POOL_REGION));
        }
    ...
    public static AmazonS3Client getS3Client(Context context) {
        if (sS3Client == null) {
            ...
            sS3Client.setRegion(Region.getRegion(Regions.fromName(BuildConfig.BUCKET_REGION)));
        }
        return sS3Client;
    }
