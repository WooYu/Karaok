...
@ActivityScope
public class WelcomeModel extends BaseModel<ServiceManager, CacheManager> implements WelcomeContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public WelcomeModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
