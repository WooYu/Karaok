...
@ActivityScope
public class RegistUserModel extends BaseModel<ServiceManager, CacheManager> implements RegistUserContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public RegistUserModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
