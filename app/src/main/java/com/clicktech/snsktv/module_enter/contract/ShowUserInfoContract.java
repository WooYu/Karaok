...
public interface ShowUserInfoContract {
    //对于经常使用的关于UI的方法可以定义到BaseView中,如显示隐藏进度条,和显示文字消息
    interface View extends BaseView {
        //调转到主页面
        void turn2Main(UserInfoBean info);
    }
    ...
    interface Model extends IModel {
        ...
        Observable<UserInfoResponse> getRegistUser(Map<String, RequestBody> info, MultipartBody.Part part);
    }
}