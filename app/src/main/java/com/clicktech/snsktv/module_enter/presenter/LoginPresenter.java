...
public class LoginPresenter extends BasePresenter<LoginContract.Model, LoginContract.View> {
     ...
     * 登录操作
     */
    public void doLogin(String thirdtype, String thirduserid) {
        mModel.getUsers(RequestParams_Maker.getLoginRequest(thirdtype, thirduserid))
                ...
                .subscribe(new ErrorHandleSubscriber<UserInfoResponse>(mErrorHandler) {
                    ...
                    public void onNext(UserInfoResponse userInfo) {
                        ...
                        if (EmptyUtils.isNotEmpty(userInfo.getNeedInfo())
                                && "1".equals(userInfo.getNeedInfo())) {
                            mRootView.turn2Regist();
                        } else {
